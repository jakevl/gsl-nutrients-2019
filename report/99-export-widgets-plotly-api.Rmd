...
sal_boxplot_mon$width='1000px'
htmlwidgets::saveWidget(sal_boxplot_mon, file=paste0(getwd(),"/htmlwidgets/07-sal_boxplot_mon.html"), title="GSL salinity by bay")
...
sal_boxplot_site$width='1000px'
htmlwidgets::saveWidget(sal_boxplot_site, file=paste0(getwd(),"/htmlwidgets/12-sal_boxplot_bay.html"), title="GSL salinity by bay")
