...
```{r, read-wq, cache=T}
wq_data=dataRetrieval::readNWISqw(expanded=F,tz="America/Denver",startDate="01-01-2010", endDate="12-31-2018",
...
#plot_ly(wq_data, x=~sample_dt) %>%
#	add_markers(y=~Salinity_gL, name='Salinity (g/L) p70305', marker=list(size=15, opacity=0.8)) %>%
#	add_markers(y=~Salinity2_gL, name='Salinity (g/L) p00480', marker=list(size=15, opacity=0.8)) %>%
#	layout(title = "GSL salinity - all sites",
#		xaxis = list(title = ""),
